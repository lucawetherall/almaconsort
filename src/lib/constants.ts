...
export const NAV_LINKS: { href: string; label: string }[] = [
  ...
  { href: `${base}scholars/`, label: 'Scholars' },
  { href: `${base}recording/`, label: 'Recording' },
  { href: `${base}events/`, label: 'Events' },
  { href: `${base}blog/`, label: 'News' },
  { href: `${base}work-with-us/`, label: 'Work With Us' },
  { href: `${base}support/`, label: 'Support' },
  { href: `${base}contact/`, label: 'Contact' },
];

/**
 * Social profiles — rendered as Footer icons and used for the JSON-LD
 * `sameAs` array in BaseLayout, so both stay in sync automatically.
 */
export const SOCIAL_LINKS: { href: string; label: string; icon: string }[] = [
  {
    href: 'https://www.instagram.com/almaconsort/',
    label: 'Instagram',
  ...
  {
    href: 'https://www.tiktok.com/@almaconsort',
    label: 'TikTok',
  ...
  {
    href: 'https://www.facebook.com/almaconsort/',
    label: 'Facebook',
